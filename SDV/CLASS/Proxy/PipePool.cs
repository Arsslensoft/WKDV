namespace BrowserWeb
{
    ...
    internal class PipePool
    {
        ...
        internal PipePool()
        {
            MSEC_PIPE_POOLED_LIFETIME = SDVPApplication.Prefs.GetInt32Pref("SDVP.network.timeouts.serverpipe.reuse", 0x1d4c0);
            this.thePool = new Dictionary<string, Queue<ServerPipe>>();
            SDVPApplication.Janitor.assignWork(new SimpleEventHandler(this.ScavengeCache), 0xea60);
        }
