namespace BrowserWeb
{
    ...
    public class ServerChatter
    {
        ...
        public int iTTFB
        {
            get
            {
                TimeSpan span = (TimeSpan) (this.m_session.Timers.ServerBeginResponse - this.m_session.Timers.SDVPBeginRequest);
        ...
        public int iTTLB
        {
            get
            {
                TimeSpan span = (TimeSpan) (this.m_session.Timers.ServerDoneResponse - this.m_session.Timers.SDVPBeginRequest);
                int totalMilliseconds = (int) span.TotalMilliseconds;
                if (totalMilliseconds <= 0)
                {
                    return 0;
