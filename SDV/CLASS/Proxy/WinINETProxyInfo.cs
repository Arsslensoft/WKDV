namespace BrowserWeb
{
    ...
    public class WinINETProxyInfo
    {
        ...
        private bool _bUseBrowserScript;
        ...
        private const int INTERNET_PER_CONN_AUTOBrowser_LAST_DETECT_TIME = 8;
        private const int INTERNET_PER_CONN_AUTOBrowser_LAST_DETECT_URL = 9;
        private const int INTERNET_PER_CONN_AUTOBrowser_RELOAD_DELAY_MINS = 7;
        private const int INTERNET_PER_CONN_AUTOBrowser_SECONDARY_URL = 6;
        private const int INTERNET_PER_CONN_AUTOBrowser_URL = 4;
