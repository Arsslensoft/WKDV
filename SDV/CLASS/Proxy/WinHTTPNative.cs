namespace BrowserWeb
{
    ...
    internal class WinHTTPNative
    {
        ...
        internal const int WINHTTP_AUTOPROXY_Browser_URL = 2;
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        [DllImport("winhttp.dll", CharSet=CharSet.Unicode, SetLastError=true)]
        internal static extern bool WinHttpDetectAutoProxyBrowserUrl([MarshalAs(UnmanagedType.U4)] int dwAutoDetectFlags, out IntPtr ppwszAutoBrowserUrl);
        [return: MarshalAs(UnmanagedType.Bool)]
        [DllImport("winhttp.dll", CharSet=CharSet.Unicode, SetLastError=true)]
        ...
        internal struct WINHTTP_AUTOPROXY_OPTIONS
        {
            ...
            public string lpszAutoBrowserUrl;
